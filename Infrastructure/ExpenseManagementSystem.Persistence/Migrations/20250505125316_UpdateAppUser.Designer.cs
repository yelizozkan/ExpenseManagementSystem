...
namespace ExpenseManagementSystem.Persistence.Migrations
{
    ...
    [Migration("20250505125316_UpdateAppUser")]
            ...
            modelBuilder.Entity("ExpenseManagementSystem.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2025, 5, 5, 12, 53, 15, 722, DateTimeKind.Utc).AddTicks(7417),
                            CreatedDateOnly = new DateOnly(2025, 5, 5),
                            Description = "Business travel and transportation",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Travel",
                            UpdatedDate = new DateTime(2025, 5, 5, 12, 53, 15, 722, DateTimeKind.Utc).AddTicks(7422),
                            UpdatedDateOnly = new DateOnly(2025, 5, 5)
                        },
                        new
                        {
                            Id = 2L,
                            CreatedDate = new DateTime(2025, 5, 5, 12, 53, 15, 722, DateTimeKind.Utc).AddTicks(7428),
                            CreatedDateOnly = new DateOnly(2025, 5, 5),
                            Description = "Food and beverages during work",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Meals",
                            UpdatedDate = new DateTime(2025, 5, 5, 12, 53, 15, 722, DateTimeKind.Utc).AddTicks(7428),
                            UpdatedDateOnly = new DateOnly(2025, 5, 5)
                        },
                        new
                        {
                            Id = 3L,
                            CreatedDate = new DateTime(2025, 5, 5, 12, 53, 15, 722, DateTimeKind.Utc).AddTicks(7430),
                            CreatedDateOnly = new DateOnly(2025, 5, 5),
                            Description = "Stationery and work materials",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Office Supplies",
                            UpdatedDate = new DateTime(2025, 5, 5, 12, 53, 15, 722, DateTimeKind.Utc).AddTicks(7431),
                            UpdatedDateOnly = new DateOnly(2025, 5, 5)
                        });
                });
            ...
            modelBuilder.Entity("ExpenseManagementSystem.Domain.Entities.ExpenseStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2025, 5, 5, 12, 53, 15, 605, DateTimeKind.Utc).AddTicks(8898),
                            CreatedDateOnly = new DateOnly(2025, 5, 5),
                            Description = "Expense is waiting for approval",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Pending",
                            UpdatedDate = new DateTime(2025, 5, 5, 12, 53, 15, 605, DateTimeKind.Utc).AddTicks(8901),
                            UpdatedDateOnly = new DateOnly(2025, 5, 5)
                        },
                        new
                        {
                            Id = 2L,
                            CreatedDate = new DateTime(2025, 5, 5, 12, 53, 15, 605, DateTimeKind.Utc).AddTicks(8910),
                            CreatedDateOnly = new DateOnly(2025, 5, 5),
                            Description = "Expense has been approved",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Approved",
                            UpdatedDate = new DateTime(2025, 5, 5, 12, 53, 15, 605, DateTimeKind.Utc).AddTicks(8910),
                            UpdatedDateOnly = new DateOnly(2025, 5, 5)
                        },
                        new
                        {
                            Id = 3L,
                            CreatedDate = new DateTime(2025, 5, 5, 12, 53, 15, 605, DateTimeKind.Utc).AddTicks(8912),
                            CreatedDateOnly = new DateOnly(2025, 5, 5),
                            Description = "Expense has been rejected",
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Rejected",
                            UpdatedDate = new DateTime(2025, 5, 5, 12, 53, 15, 605, DateTimeKind.Utc).AddTicks(8912),
                            UpdatedDateOnly = new DateOnly(2025, 5, 5)
                        });
                });
            ...
            modelBuilder.Entity("ExpenseManagementSystem.Domain.Entities.Identity.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "82d8892f-890e-40be-9967-a4581f60f5cf",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEAVcg77LpUO6Wjidfg7lkn17cgRBqulS3IsISzDDTGAY3ROgPKS8KbTwGnf4r7xy2Q==",
                            PhoneNumberConfirmed = false,
                            Position = "Admin",
                            SecurityStamp = "36e28d0d-9994-409e-90c9-adce32303462",
                        ...
                        new
                        {
                            Id = 2L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "671d14d6-77a4-421d-992f-5d27cf87a3f5",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEGGTT6606CLM+03MhM0qcuyVRUngk2F8uFLuUPZnxGRg9tsUH1UW4aQqFMmBfFYQJQ==",
                            PhoneNumberConfirmed = false,
                            Position = "Personel",
                            SecurityStamp = "f4c163bf-48c9-4397-8b20-2ba0b3f5b759",
                            TwoFactorEnabled = false,

...
namespace ExpenseManagementSystem.Persistence.Migrations
{
    ...
    [Migration("20250503075120_AddedIdentityAndEntityChanges")]
    partial class AddedIdentityAndEntityChanges
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseManagementSystem.Domain.Identity.AppRole", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AspNetRoles", "table");
                });

            modelBuilder.Entity("ExpenseManagementSystem.Domain.Identity.AppUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<long>", b =>
                {
                    ...
                    b.ToTable("AspNetUserRoles", "table");
                });
            ...
            modelBuilder.Entity("ExpenseManagementSystem.Domain.Entities.Expense", b =>
                {
                    b.HasOne("ExpenseManagementSystem.Domain.Identity.AppUser", "ApprovedBy")
                        .WithMany()
                    ...
                    b.HasOne("ExpenseManagementSystem.Domain.Identity.AppUser", "User")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<long>", b =>
                {
                    b.HasOne("ExpenseManagementSystem.Domain.Identity.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("ExpenseManagementSystem.Domain.Identity.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
